...
public class ProductFormDialog extends JDialog {
    ...
    private String savedImagePath;  // relative path to image like "images/cappuccino.jpg"
    private boolean saved = false;
    private Product product; // existing product if editing
    ...
    private void initUI() {
        ...
        // Enable drag and drop on dropLabel
    ...
    private void populateFields(Product p) {
        ...
        if (savedImagePath != null && !savedImagePath.isEmpty()) {
            dropLabel.setText("<html><center>Current Image:<br>" + savedImagePath + "</center></html>");
        }
    }
